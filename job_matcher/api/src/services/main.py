...
STOPWORDS = {
    ...
    "we", "us", "our", "about", "into", "their", "they", "will", "all", "also", ".", "student", "edu",
    "education", "learning", "microsoft", "alexandria"
}
...
class CVMatcher:
    def __init__(self):
        # Get the directory of the current file (services/main.py)
        base_dir = os.path.dirname(os.path.abspath(__file__))
        self.data_path = os.path.join(base_dir, "..", "static", "job_data.csv")
